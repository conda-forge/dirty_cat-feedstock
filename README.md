...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dirty_cat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14997&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dirty_cat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dirty_cat` can be installed with:

```
conda install dirty_cat
```

It is possible to list all of the versions of `dirty_cat` available on your platform with:
